const { PermissionBitField, ChannelType } = require('discord.js');
...
function createStatsCategory(guild, bot) {
  return guild.channels.create({
    ...
    permissionOverwrites: [
      {
        id: guild.id,
        deny: [PermissionBitField.Flags.Connect],
      },
      {
        id: bot.id,
        allow: [PermissionBitField.Flags.Connect],
      },
    ],
  });
}
